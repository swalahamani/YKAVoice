...
import {httpStatusCodes} from "@config/types/NetworkTypes";
 ...
 * @param apiServer
 */
function YKAVoiceServerAxiosResponseInterceptors(
...
export default YKAVoiceServerAxiosResponseInterceptors;
